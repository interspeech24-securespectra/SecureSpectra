...
def general_testing_func_EER(signModelDir = "./best_model_sign_libri.pt", verifyModelDir = "./best_model_verify_libri.pt",mel_data_dir="/home/obiwan/training_mels_librispeech/trainingMels.npy"):
    # set the directory to the right place
...
def general_testing_func_EER_verificationOnly(verifyModelDir = "/home/obiwan/repos/watermarking_module/libri_experiments/best_model_verify_only_libri.pt",mel_data_dir="/home/obiwan/training_mels_librispeech/trainingMels.npy", labels_dir="/home/obiwan/training_mels_librispeech/trainingY.npy"):
 
    
    originalMelData = np.load(mel_data_dir)
    originalMelLabels = np.load(labels_dir)
    num_samples = int(originalMelLabels.shape[0]*0.9)
    originalMelData = originalMelData[num_samples:]
    originalMelLabels = originalMelLabels[num_samples:]
    # code for the audio signing
    ...
    evalX = originalMelData
    evalY = originalMelLabels
...
print("EER Results for SecureSpectra (All) on LibriSpeech Dataset")
general_testing_func_EER()
# general_testing_func_EER_verificationOnly()