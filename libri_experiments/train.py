...
def main(args):
    ...
    seed(1)
    datasetX_loc = "./training_mels_librispeech/trainingMels.npy"
    datasetY_loc = "./training_mels_librispeech/trainingY.npy"
    ...
    # TODO give these parameters as arguments
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        if epochValLossSign < minimum_validation_loss:
            ...
            if epoch>initialization_rounds:
                # Save the model
                torch.save(signModel.state_dict(), 'best_model_sign_libri.pt')
                torch.save(verifyModel.state_dict(), 'best_model_verify_libri.pt')
        else:
